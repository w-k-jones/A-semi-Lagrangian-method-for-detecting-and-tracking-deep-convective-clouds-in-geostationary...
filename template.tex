...
\title{A Semi-Lagrangian Method for Detecting and Tracking Deep Convective Clouds in Geostationary Satellite Observations}
...
\affil[1]{Atmospheric, Oceanic \& Planetary Physics, Department of Physics, University of Oxford, Oxford, UK}
...
Furthermore, we expect this framework to applicable to a wide range of cases including the detection and tracking of low-level clouds and other atmospheric phenomena.
...
% Furthermore, unlike observations from weather radars or lightning detectors, satellite imagery is capable of detecting DCCs and their associated anvil clouds throughout their entire lifecycle (figure \ref{fig:compare_sat_radar_glm}).
...
% To avoid the use of a fixed threshold for the detection of DCCs, an edge detection based approach is used for the watershedding of detected DCCs, which is demonstrated in figure \ref{fig:watershed}.
